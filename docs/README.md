...
](01_task_orchestration___main_py___.md)
2. [Hydra Configuration Management
](02_hydra_configuration_management_.md)
3. [Data Querying & Sampling (`query.py`)
](03_data_querying___sampling___query_py___.md)
4. [Preprocessing Pipeline (`preprocess.py` & `src/preprocessing/`)
](04_preprocessing_pipeline___preprocess_py_____src_preprocessing____.md)
5. [Data Loading & Augmentation (`datasets.py`, `augs.py`)
](05_data_loading___augmentation___datasets_py____augs_py___.md)
6. [Segmentation Model Module (`model.py`)
](06_segmentation_model_module___model_py___.md)
7. [Training Orchestration (`train.py`)
](07_training_orchestration___train_py___.md)
8. [Inference Pipeline (`inference.py`)
](08_inference_pipeline___inference_py___.md)
9. [File Synchronization (`sync.py`)
](09_file_synchronization___sync_py___.md)
